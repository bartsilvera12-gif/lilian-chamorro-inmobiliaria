...
const en: Translations = {
  ...
  'hero.title': 'Your next home in Asunción',
  'hero.subtitle': 'Buy, sell and rent properties with the trust of OSORIO INMOBILIARIA EAS',
...
const pt: Translations = {
  ...
  'hero.title': 'Seu próximo lar em Assunção',
  'hero.subtitle': 'Compra, venda e aluguel de imóveis com a confiança da OSORIO INMOBILIARIA EAS',
